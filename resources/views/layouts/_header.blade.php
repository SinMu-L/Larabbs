  ...
  <div class="container">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        @foreach ($categories as $category)
          <li class="nav-item @if (request()->url() == route('categories.show', $category->id )) active
            @endif"><a class="nav-link" href="{{ route('categories.show', $category->id) }}">{{$category->name}}</a></li>
        @endforeach
      </ul>
